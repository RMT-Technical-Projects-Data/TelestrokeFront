...
const EMRpage = () => {
  ...
  const [settings,setSettings]=useState({eye_camera_control:"", exam_mode:"", stimulus_type:"",speed:"",stop:"",coordinates:""})
  ...
  <div className="flex flex-row gap-14">
    ...
    <p>
      <span className="text-[rgb(5,60,212)]">Gender:</span> Male
            ...
            {meetingid ? (
              <>
                <div className="flex flex-row  justify-between h-[720px] gap-8 py-5 px-3">
                  ...
                  { meetingJoined && <div className="bg-slate-200 p-5 rounded-md ">
               
                  <div className="basis-[30%] flex flex-col gap-3  justify-evenly items-left">
                    
                    <h3 className="font-bold text-2xl text-center ">Video Control Panel</h3>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={()=>{setSelectedEye("left");updateSetting("eye_camera_control","left")}}
                      />
                      ...
                      <input
                        ...
                        onChange={()=>{setSelectedEye("right");updateSetting("eye_camera_control","right")}}
                    ...
                    {/* <div>
                      <input
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="eyePlacementBox" className="text-lg">
                        Show Eye Placement Box
                      </label>
                    </div> */}
                    <label
                      htmlFor="examMode"
                    ...
                    {centerFocus ? ( <StimulusVideoController settings={settings} updateSetting={updateSetting} />) : (<QuadrantTracking settings={settings} updateSetting={updateSetting} />)}
                    {/* <div>
                      <input type="checkbox" id="showRedDot" className="mr-2" />
                      <label htmlFor="showRedDot" className="text-lg">
                        Show Red Dot
                      </label>
                    </div> */}
                  </div>
            ...
            {meetingid && (
              <>
                {/* <p className="font-bold text-xl">Select Video</p>
                <div className="h-44 bg-slate-200 flex flex-row gap-4 p-3 ">
                  <div className="w-[20%] h-[100%] bg-slate-400"></div>
                  <div className="w-[20%] h-[100%] bg-slate-400"></div>
                  <div className="w-[20%] h-[100%] bg-slate-400"></div>
                  <div className="w-[20%] h-[100%] bg-slate-400"></div>
                  <div className="w-[20%] h-[100%] bg-slate-400"></div>
