...
const NavBar = ({ disableDashboardLink = false }) => {
  ...
  return (
    <div className="bg-white w-screen h-[7%] p-1 py-0 px-7 flex flex-row justify-between border-b-2 border-gray-300 text-gray-800 z-50 fixed top-0 left-0">
        ...
        {!disableDashboardLink ? (
          ...
          >
            <img
              ...
              alt="logo"
              className="inline"
              style={{ width: "auto", maxHeight: "100px" }} // Adjusted size
            />
